...
-- mojito Effect
RegisterNetEvent('esx_disco:drinkmojito')
AddEventHandler('esx_disco:drinkmojito', function()
...
-- champagne Effect
RegisterNetEvent('esx_disco:drinkchampagne')
AddEventHandler('esx_disco:drinkchampagne', function()
	RequestAnimSet("MOVE_M@DRUNK@VERYDRUNK")
    while not HasAnimSetLoaded("MOVE_M@DRUNK@VERYDRUNK") do
        Citizen.Wait(0)
    end
