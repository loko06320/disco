...
ESX.RegisterUsableItem('mojito', function(source)
	...
	TriggerClientEvent('esx_discojob:onHijack', _source)
    TriggerClientEvent('esx:showNotification', _source, 'Vous avez consommé un ~b~Mojito')
...
ESX.RegisterUsableItem('vodka', function(source)
	...
	TriggerClientEvent('esx_discojob:onFixkit', _source)
    TriggerClientEvent('esx:showNotification', _source, 'Vous avez consommé une ~b~Vodka')
...
ESX.RegisterUsableItem('champagne', function(source)
	...
	TriggerClientEvent('esx_discojob:onCarokit', _source)
    TriggerClientEvent('esx:showNotification', _source, 'Vous avez consommé du ~b~Champagne')
